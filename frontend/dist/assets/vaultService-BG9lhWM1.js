const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-3GDgBUYF.js","assets/pdf-utils-r4RjNe6V.js","assets/compression-utils-CXh1ITwj.js","assets/vue-core-Daban9YF.js","assets/element-plus-Dh0klhaa.js","assets/element-plus-Dh61In7b.css","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-C-OQsQoR.js","assets/index-CKCC89YU.css"])))=>i.map(i=>d[i]);
import { _ as q, __tla as __tla_0 } from "./pdf-utils-r4RjNe6V.js";
import { n as F, o as H, l as D, r as y, b as G, p as w, u as K, s as J, g as W, q as _, a as N, __tla as __tla_1 } from "./index-3GDgBUYF.js";
import { l as B, __tla as __tla_2 } from "./resourceRegistry-COxFgigF.js";
import { f as Z, e as z } from "./vue-core-Daban9YF.js";
let At, x, wt, ht, yt, mt, ft, pt, dt, gt, Q, St, vt, et, nt, at, ot, st;
    ...
    async function j(t, r = 30, e = 6, n = "SHA-1", s = 0) {
        ...
        try {
            ...
            if (F("using hash-wasm fallback for TOTP generation.")) {
                const v = await B("hash-wasm"), { createHMAC: C, createSHA1: S, createSHA256: T, createSHA512: g } = v?.default || v;
                let b;
                f.hash === "SHA-256" ? b = T() : f.hash === "SHA-512" ? b = g() : b = S();
                const O = await C(b, o);
    ...
    async function X(t, r = 30, e = 0) {
        ...
        try {
            ...
            if (F("using hash-wasm fallback for Steam TOTP generation.")) {
                const p = await B("hash-wasm"), { createHMAC: A, createSHA1: v } = p?.default || p, C = await A(v(), n);
                C.init(), C.update(new Uint8Array(i));
                const S = C.digest("hex"), T = new Uint8Array(S.length / 2);
                for(let g = 0; g < S.length; g += 2)T[g / 2] = parseInt(S.substring(g, g + 2), 16);
                l = T.buffer;
            } else {
            ...
            return D.error("Steam TOTP Error", n), "ERROR";
        }
    }
    async function Y(t, r = 0, e = 6, n = "SHA-1") {
        ...
        try {
            ...
            if (F("using hash-wasm fallback for HOTP generation.")) {
                const h = await B("hash-wasm"), { createHMAC: p, createSHA1: A, createSHA256: v, createSHA512: C } = h?.default || h;
                let S;
                a.hash === "SHA-256" ? S = v() : a.hash === "SHA-512" ? S = C() : S = A();
                const T = await p(S, s);
                T.init(), T.update(new Uint8Array(o));
                const g = T.digest("hex"), b = new Uint8Array(g.length / 2);
                for(let O = 0; O < g.length; O += 2)b[O / 2] = parseInt(g.substring(O, O + 2), 16);
                u = b.buffer;
            } else {
        ...
        async getTrashList () {
            ...
            try {
                const { useLayoutStore: r } = await q(async ()=>{
                    const { useLayoutStore: o } = await import("./index-3GDgBUYF.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.x);
                    return {
                        ...
                        if (!h?.success) {
                            ...
                            if (v) {
                                ...
                                const { useOfflineStore: S } = await q(async ()=>{
                                    const { useOfflineStore: g } = await import("./index-3GDgBUYF.js").then(async (m)=>{
                                        await m.__tla;
                                        return m;
                                    }).then((b)=>b.y);
                                    return {
...
export { At as O, x as a, wt as b, ht as c, yt as d, mt as e, ft as f, pt as g, dt as h, gt as i, Q as j, St as k, vt as l, et as n, nt as p, at as t, ot as u, st as v, __tla };
