...
import { n as le, O as Ae, p as V, b as ee, v as fe, __tla as __tla_0 } from "./vaultService-BG9lhWM1.js";
import { B as xe, S as ce, a as Se, b as G, c as Ee, d as Te, M as ve, s as Ie, F as Pe, e as ue, f as Ue, g as Oe } from "./wa-sqlite-l0JLtCOf.js";
import { l as pe, d as Le, e as De, __tla as __tla_1 } from "./index-3GDgBUYF.js";
import { a as Re } from "./qr-utils-DSii33i3.js";
import { _ as _e, __tla as __tla_2 } from "./pdf-utils-r4RjNe6V.js";
import { a as de } from "./argon2-browser-qelKfid9.js";
    ...
    const Fe = {
        detect (n, r) {
            if (n instanceof ArrayBuffer || n instanceof Uint8Array) {
                ...
                let i = !0;
                for(let p = 0; p < o.length && p < t.length; p++)if (t[p] !== o.charCodeAt(p)) {
                    i = !1;
                    break;
                }
                ...
                try {
                    ...
                    if (p.includes("accounts") && (p.includes("oath_secret_key") || p.includes("encrypted_oath_secret_key"))) return "phonefactor";
                } catch  {}
            }
...
`)[0].toLowerCase() : "";
    ...
    class ke extends xe {
        ...
        xRead(r, e, t) {
            const o = this.mapIdToFile.get(r), i = Math.min(t, o.size), u = Math.min(t + e.byteLength, o.size) - i;
            return u && e.set(new Uint8Array(o.data, i, u)), u < e.byteLength ? (e.fill(0, u), Te) : G;
        }
        xWrite(r, e, t) {
            const o = this.mapIdToFile.get(r);
            if (t + e.byteLength > o.data.byteLength) {
                const i = Math.max(t + e.byteLength, 2 * o.data.byteLength), p = new ArrayBuffer(i);
                new Uint8Array(p).set(new Uint8Array(o.data, 0, o.size)), o.data = p;
            }
    ...
    const Ve = {
        ...
        async parse (n) {
            ...
            try {
                ...
                o.name = u, p.vfs_register(o);
                const g = "PhoneFactor", A = (a, l)=>{
                    const c = l.buffer.slice(l.byteOffset, l.byteOffset + l.byteLength);
                ...
                const m = await p.open_v2(g, ue | ce, u);
                await p.exec(m, "PRAGMA locking_mode = EXCLUSIVE;"), await p.exec(m, "PRAGMA journal_mode = DELETE;");
                let w = !1;
                if (await p.exec(m, "SELECT name FROM sqlite_master WHERE type='table' AND name='accounts'", ()=>{
                    w = !0;
                }), !w) throw await p.close(m), new P("不是有效的 Microsoft Authenticator 数据文件", "INVALID_PHONEFACTOR_FILE");
                const y = [], x = /^[A-Z2-7]+=*$/i, f = p.str_new(m, "SELECT name, username, oath_secret_key, encrypted_oath_secret_key, account_type FROM accounts"), s = await p.prepare_v2(m, p.str_value(f));
                if (s && s.stmt) {
                    const a = s.stmt;
                    try {
                        for(; await p.step(a) === Oe;){
                            const l = p.row(a), c = l[0], h = l[1], d = l[2], _ = l[4];
                            if (!c && !h) continue;
                ...
                if (p.str_finish(f), await p.close(m), o.mapNameToFile.clear(), y.length === 0) throw new P("未能提取到有效的 TOTP 记录", "NO_DATA");
                return y;
            } catch (i) {
                throw pe.error("[PhoneFactor] parse failed:", i), i instanceof P ? i : new P(`PhoneFactor 解析失败: ${i.message}`, "PF_ERROR", i);
            }
        }
    }, He = {
        async parseImage (n) {
            return new Promise((r, e)=>{
                ...
                t.onload = ()=>{
                    ...
                    let g = null;
                    for (const m of u){
                        i.width = t.width * m, i.height = t.height * m, p.imageSmoothingEnabled = !1, p.drawImage(t, 0, 0, i.width, i.height);
                        const w = p.getImageData(0, 0, i.width, i.height);
        ...
        decodePayload (n) {
            ...
            function t() {
                ...
                for(; e < n.length;){
                    const p = n[e++];
                    if (o |= (p & 127) << i, (p & 128) === 0) break;
                    i += 7;
                }
                return o;
            }
            for(; e < n.length;){
                const o = n[e++], i = o >> 3, p = o & 7;
                if (i === 1 && p === 2) {
                    const u = t(), g = e + u;
                    let A = null, m = "", w = "", y = "SHA1", x = 6, E = "totp", f = 0;
                    for(; e < g;){
                        const s = n[e++], a = s >> 3, l = s & 7;
                        if (a === 1 && l === 2) {
                        ...
                        } else if (a === 5 && l === 0) t() === 2 && (x = 8);
                        else if (a === 6 && l === 0) E = t() === 1 ? "hotp" : "totp";
                        else if (a === 7 && l === 0) f = t();
                        else if (l === 0) t();
                        else if (l === 2) e += t();
                        else break;
        ...
        async exportToGoogleAuth (n) {
            ...
            const i = Math.floor(Math.random() * 2147483647), p = await _e(()=>import("./qr-utils-DSii33i3.js").then((w)=>w.b), __vite__mapDeps([0,1,2,3])), u = [];
            function g(w, y) {
            ...
            for(let w = 0; w < o.length; w++){
                ...
                for (const a of y){
                    const l = [], c = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", h = a.secret.toUpperCase().replace(/=+$/, "").replace(/[^A-Z2-7]/g, ""), d = [];
                    let _ = 0, b = 0;
                    for(let D = 0; D < h.length; D++){
                        const U = c.indexOf(h[D]);
                        U !== -1 && (b = b << 5 | U, _ += 5, _ >= 8 && (d.push(b >>> _ - 8 & 255), _ -= 8));
                    }
                    d.length > 0 && (l.push(10), m(d, l));
                    const S = a.account || a.service;
                    S && (l.push(18), A(S, l)), a.service && (l.push(26), A(a.service, l));
                    let v = 1;
                    a.algorithm === "SHA256" ? v = 2 : a.algorithm === "SHA512" && (v = 3), l.push(32), g(v, l);
                    let I = 1;
                    a.digits === 8 && (I = 2), l.push(40), g(I, l);
                    let L = 2;
                    a.type === "hotp" && (L = 1), l.push(48), g(L, l), a.type === "hotp" && (l.push(56), g(a.counter || 0, l)), x.push(10), g(l.length, x);
                    for(let D = 0; D < l.length; D++)x.push(l[D]);
                }
                let E = "";
                for(let a = 0; a < x.length; a++)E += String.fromCharCode(x[a]);
                const f = `otpauth-migration://offline?data=${encodeURIComponent(btoa(E))}`, s = await p.toDataURL(f, {
...
`).filter((f)=>f.trim());
            ...
            const e = this._splitCsvLine(r[0]).map((f)=>f.toLowerCase()), t = [], o = e.includes("login_totp"), i = e.includes("otpauth") && !e.includes("title"), p = e.includes("otpauth") && e.includes("title"), u = e.includes("totp") && e.includes("vault") && e.includes("createtime"), g = e.includes("otpurl") && e.includes("title") && e.includes("username"), A = e.includes("issuer") || e.includes("secret") || e.includes("name"), m = [
                "otpauth",
                "login_totp",
                "totp",
                "mfa",
            ...
            if (!o && !i && !p && !u && !g && !A && !E) return [];
            for(let f = 1; f < r.length; f++){
                const s = this._splitCsvLine(r[f]), a = {};
                if (e.forEach((l, c)=>{
                    a[l] = s[c] || "";
                }), p) {
                    ...
                    if (l) {
                        let c = null;
                        if (l.startsWith("otpauth://") || l.startsWith("steam://")) c = V(l);
                        else {
                            const h = x(l);
                            /^[A-Z2-7]+=*$/.test(h) && (c = {
                    ...
                    const l = e.find((h)=>m.includes(h)), c = l ? (a[l] || "").trim() : "";
                    if (c) if (c.toLowerCase().startsWith("otpauth://") || c.toLowerCase().startsWith("steam://")) {
                        ...
                        const h = x(c);
                        if (/^[A-Z2-7]+=*$/.test(h)) {
                            let _ = e.find((L)=>w.includes(L)), b = e.find((L)=>y.includes(L));
...
`;
            return n.forEach((e)=>{
                const t = e.account || "", o = e.service || "", i = e.type?.toUpperCase() || "TOTP", p = e.category || "";
                r += `"${t}","${o}",${e.secret},${e.algorithm || "SHA1"},${e.digits || 6},${e.period || 30},${i},${e.counter || 0},"${p}"
`;
            }), r;
        }
    };
        ...
        return he || (he = 1, (function(n, r) {
            (function(e) {
                function o(f) {
                    ...
                    let a = 1779033703, l = 3144134277, c = 1013904242, h = 2773480762, d = 1359893119, _ = 2600822924, b = 528734635, S = 1541459225;
                    const v = new Uint32Array(64);
                    function I(H) {
                        let Q = 0, k = H.length;
                        for(; k >= 64;){
                            let N = a, W = l, $ = c, z = h, T = d, B = _, O = b, Y = S, M, R, X, Z, te;
                            for(R = 0; R < 16; R++)X = Q + R * 4, v[R] = (H[X] & 255) << 24 | (H[X + 1] & 255) << 16 | (H[X + 2] & 255) << 8 | H[X + 3] & 255;
                            for(R = 16; R < 64; R++)M = v[R - 2], Z = (M >>> 17 | M << 15) ^ (M >>> 19 | M << 13) ^ M >>> 10, M = v[R - 15], te = (M >>> 7 | M << 25) ^ (M >>> 18 | M << 14) ^ M >>> 3, v[R] = (Z + v[R - 7] | 0) + (te + v[R - 16] | 0) | 0;
                            for(R = 0; R < 64; R++)Z = (((T >>> 6 | T << 26) ^ (T >>> 11 | T << 21) ^ (T >>> 25 | T << 7)) + (T & B ^ ~T & O) | 0) + (Y + (s[R] + v[R] | 0) | 0) | 0, te = ((N >>> 2 | N << 30) ^ (N >>> 13 | N << 19) ^ (N >>> 22 | N << 10)) + (N & W ^ N & $ ^ W & $) | 0, Y = O, O = B, B = T, T = z + Z | 0, z = $, $ = W, W = N, N = Z + te | 0;
                            a = a + N | 0, l = l + W | 0, c = c + $ | 0, h = h + z | 0, d = d + T | 0, _ = _ + B | 0, b = b + O | 0, S = S + Y | 0, Q += 64, k -= 64;
                        }
                    }
                    I(f);
                    let L, D = f.length % 64, U = f.length / 536870912 | 0, F = f.length << 3, J = D < 56 ? 56 : 120, C = f.slice(f.length - D, f.length);
                    for(C.push(128), L = D + 1; L < J; L++)C.push(0);
                    return C.push(U >>> 24 & 255), C.push(U >>> 16 & 255), C.push(U >>> 8 & 255), C.push(U >>> 0 & 255), C.push(F >>> 24 & 255), C.push(F >>> 16 & 255), C.push(F >>> 8 & 255), C.push(F >>> 0 & 255), I(C), [
                        a >>> 24 & 255,
                        a >>> 16 & 255,
                        a >>> 8 & 255,
                        a >>> 0 & 255,
                ...
                function i(f, s, a) {
                    f = f.length <= 64 ? f : o(f);
                    const l = 64 + s.length + 4, c = new Array(l), h = new Array(64);
                    let d, _ = [];
                    for(d = 0; d < 64; d++)c[d] = 54;
                    for(d = 0; d < f.length; d++)c[d] ^= f[d];
                    for(d = 0; d < s.length; d++)c[64 + d] = s[d];
                    for(d = l - 4; d < l; d++)c[d] = 0;
                    for(d = 0; d < 64; d++)h[d] = 92;
                    for(d = 0; d < f.length; d++)h[d] ^= f[d];
                    function b() {
                        for(let S = l - 1; S >= l - 4; S--){
                ...
                function p(f, s, a, l, c) {
                    let h;
                    for(m(f, (2 * a - 1) * 16, c, 0, 16), h = 0; h < 2 * a; h++)A(f, h * 16, c, 16), g(c, l), m(c, 0, f, s + h * 16, 16);
                    for(h = 0; h < a; h++)m(f, s + h * 2 * 16, f, h * 16, 16);
                    for(h = 0; h < a; h++)m(f, s + (h * 2 + 1) * 16, f, (h + a) * 16, 16);
                }
                function u(f, s) {
                    return f << s | f >>> 32 - s;
                }
                function g(f, s) {
                    m(f, 0, s, 0, 16);
                    for(let a = 8; a > 0; a -= 2)s[4] ^= u(s[0] + s[12], 7), s[8] ^= u(s[4] + s[0], 9), s[12] ^= u(s[8] + s[4], 13), s[0] ^= u(s[12] + s[8], 18), s[9] ^= u(s[5] + s[1], 7), s[13] ^= u(s[9] + s[5], 9), s[1] ^= u(s[13] + s[9], 13), s[5] ^= u(s[1] + s[13], 18), s[14] ^= u(s[10] + s[6], 7), s[2] ^= u(s[14] + s[10], 9), s[6] ^= u(s[2] + s[14], 13), s[10] ^= u(s[6] + s[2], 18), s[3] ^= u(s[15] + s[11], 7), s[7] ^= u(s[3] + s[15], 9), s[11] ^= u(s[7] + s[3], 13), s[15] ^= u(s[11] + s[7], 18), s[1] ^= u(s[0] + s[3], 7), s[2] ^= u(s[1] + s[0], 9), s[3] ^= u(s[2] + s[1], 13), s[0] ^= u(s[3] + s[2], 18), s[6] ^= u(s[5] + s[4], 7), s[7] ^= u(s[6] + s[5], 9), s[4] ^= u(s[7] + s[6], 13), s[5] ^= u(s[4] + s[7], 18), s[11] ^= u(s[10] + s[9], 7), s[8] ^= u(s[11] + s[10], 9), s[9] ^= u(s[8] + s[11], 13), s[10] ^= u(s[9] + s[8], 18), s[12] ^= u(s[15] + s[14], 7), s[13] ^= u(s[12] + s[15], 9), s[14] ^= u(s[13] + s[12], 13), s[15] ^= u(s[14] + s[13], 18);
                    for(let a = 0; a < 16; ++a)f[a] += s[a];
                }
                function A(f, s, a, l) {
                    for(let c = 0; c < l; c++)a[c] ^= f[s + c];
                }
                function m(f, s, a, l, c) {
                    for(; c--;)a[l++] = f[s++];
                }
                function w(f) {
                ...
                function y(f, s) {
                    if (typeof f != "number" || f % 1) throw new Error("invalid " + s);
                    return f;
                }
                function x(f, s, a, l, c, h, d) {
                    if (a = y(a, "N"), l = y(l, "r"), c = y(c, "p"), h = y(h, "dkLen"), a === 0 || (a & a - 1) !== 0) throw new Error("N must be power of 2");
                    if (a > 2147483647 / 128 / l) throw new Error("N too large");
                    if (l > 2147483647 / 128 / c) throw new Error("r too large");
                    if (!w(f)) throw new Error("password must be an array or buffer");
                    if (f = Array.prototype.slice.call(f), !w(s)) throw new Error("salt must be an array or buffer");
                    s = Array.prototype.slice.call(s);
                    let _ = i(f, s, c * 128 * l);
                    const b = new Uint32Array(c * 32 * l);
                    for(let T = 0; T < b.length; T++){
                        const B = T * 4;
                        b[T] = (_[B + 3] & 255) << 24 | (_[B + 2] & 255) << 16 | (_[B + 1] & 255) << 8 | (_[B + 0] & 255) << 0;
                    }
                    const S = new Uint32Array(64 * l), v = new Uint32Array(32 * l * a), I = 32 * l, L = new Uint32Array(16), D = new Uint32Array(16), U = c * a * 2;
                    let F = 0, J = null, C = !1, H = 0, Q = 0, k, N;
                    const W = d ? parseInt(1e3 / l) : 4294967295, $ = typeof setImmediate < "u" ? setImmediate : setTimeout, z = function() {
                        if (C) return d(new Error("cancelled"), F / U);
                        let T;
                        switch(H){
                            case 0:
                                N = Q * 32 * l, m(b, N, S, 0, I), H = 1, k = 0;
                            case 1:
                                T = a - k, T > W && (T = W);
                                for(let O = 0; O < T; O++)m(S, 0, v, (k + O) * I, I), p(S, I, l, L, D);
                                if (k += T, F += T, d) {
                                    const O = parseInt(1e3 * F / U);
                                    if (O !== J) {
                                        if (C = d(null, F / U), C) break;
                                        J = O;
                                    }
                                }
                                if (k < a) break;
                            ...
                            case 2:
                                T = a - k, T > W && (T = W);
                                for(let O = 0; O < T; O++){
                                    const Y = (2 * l - 1) * 16, M = S[Y] & a - 1;
                                    A(v, M * I, S, I), p(S, I, l, L, D);
                                }
                                if (k += T, F += T, d) {
                                    const O = parseInt(1e3 * F / U);
                                    if (O !== J) {
                ...
                const E = {
                    scrypt: function(f, s, a, l, c, h, d) {
                        return new Promise(function(_, b) {
                            let S = 0;
                            d && d(0), x(f, s, a, l, c, h, function(v, I, L) {
                                if (v) b(v);
                                else if (L) d && S !== 1 && d(1), _(new Uint8Array(L));
                                else if (d && I !== S) return S = I, d(I);
                            });
                        });
                    },
                    syncScrypt: function(f, s, a, l, c, h) {
                        return new Uint8Array(x(f, s, a, l, c, h));
                    }
                };
                n.exports = E;
            })();
    ...
    const se = {
        async decryptDatabase (n, r) {
            ...
            for (const y of e)if (y.type === 1) {
                const x = q(y.salt), E = await ze.scrypt(p, x, y.n, y.r, y.p, 32), f = q(y.key), s = q(y.key_params.nonce), a = q(y.key_params.tag), l = new Uint8Array(f.length + a.length);
                l.set(f), l.set(a, f.length);
                try {
            ...
            const u = Me(t), g = q(o.nonce), A = q(o.tag), m = new Uint8Array(u.length + A.length);
            m.set(u), m.set(A, u.length);
        ...
        exportPlaintext (n) {
            ...
            const e = Array.from(r.entries()).map(([o, i])=>({
                ...
                const p = (o.type || "totp").toLowerCase(), u = p === "steam", A = u || p === "blizzard" ? "totp" : p, m = {
                    secret: o.secret,
                    algo: (o.algorithm || "SHA1").toUpperCase(),
                    digits: u ? 5 : o.digits || 6
                };
                return p === "hotp" ? m.counter = o.counter || 0 : m.period = o.period || 30, {
                    type: A,
        ...
        async exportToHtml (n) {
            const r = await _e(()=>import("./qr-utils-DSii33i3.js").then((t)=>t.b), __vite__mapDeps([0,1,2,3])), e = [];
            e.push(`
      <!DOCTYPE html>
      <html>
      <head>
...
`);
        ...
        async decrypt (n, r) {
            try {
                ...
                const i = [
                    ...
                    t[1],
                    t.slice(2).join(":")
                ].map((c)=>Uint8Array.from(atob(c.replace(/\s+/g, "")), (h)=>h.charCodeAt(0))), p = (c)=>{
                ...
                if (!u || !g || !A) {
                    ...
                    for (const d of h)if (!(!d.salt || !d.iv || !d.cipher) && d.iv.length === K.IV_LEN) try {
                        ...
                        if (d.cipher.length >= 16) {
                            const v = d.cipher.slice(d.cipher.length - 16), I = d.cipher.slice(0, d.cipher.length - 16), L = await crypto.subtle.decrypt({
                                name: "AES-GCM",
                                iv: d.iv
                            }, S, new Uint8Array([
                                ...I,
                                ...v
                            ])), D = new TextDecoder().decode(L);
                            JSON.parse(D), u = d.salt, g = d.iv, A = d.cipher, c = !0;
                            break;
                        }
                    } catch  {}
                    !c && !u && (u = i[0], g = i[1], A = i[2], u.length !== K.SALT_LEN && g.length === K.SALT_LEN && ([u, g] = [
                        g,
                        u
                    ]), g.length !== K.IV_LEN && A.length === K.IV_LEN && ([g, A] = [
                        A,
                        g
                    ]));
                }
                if (u.length < 16) throw new P(`salt 长度过短：${u.length}`, "INVALID_SALT_LEN");
                if (g.length !== K.IV_LEN) throw new P("IV 长度错误", "INVALID_IV_LEN");
                ...
                const E = A.slice(A.length - 16), f = A.slice(0, A.length - 16), s = await crypto.subtle.decrypt({
                    name: "AES-GCM",
                    iv: g
                }, x, new Uint8Array([
                    ...f,
                    ...E
                ])), a = new TextDecoder().decode(s), l = JSON.parse(a);
                if (!Array.isArray(l)) throw new P("解密后的数据不是数组格式", "INVALID_DECRYPTED_FORMAT");
                return l;
            } catch (e) {
        ...
        async decrypt (n, r) {
            try {
                ...
                const i = new TextEncoder().encode(e), p = new TextEncoder().encode(n), u = await crypto.subtle.importKey("raw", p, {
                    name: "PBKDF2"
                }, !1, [
                    "deriveBits"
                    ...
                    iterations: t,
                    hash: "SHA-256"
                }, u, 256), A = new Uint8Array(g), m = await this._hkdfExpandSha256(A, "enc", 32), w = await this._hkdfExpandSha256(A, "mac", 32), y = async (f, s, a)=>{
                    const l = f.split(".");
                    if (l[0] !== "2") throw new Error("Unsupported encryption type");
                    const c = l[1].split("|"), h = Uint8Array.from(atob(c[0]), (U)=>U.charCodeAt(0)), d = Uint8Array.from(atob(c[1]), (U)=>U.charCodeAt(0)), _ = Uint8Array.from(atob(c[2]), (U)=>U.charCodeAt(0)), b = await crypto.subtle.importKey("raw", a, {
                        name: "HMAC",
                        hash: "SHA-256"
                    }, !1, [
                        "sign"
                    ...
                    let I = 0;
                    for(let U = 0; U < _.length; U++)I |= _[U] ^ v[U];
                    if (I !== 0) return null;
                    const L = await crypto.subtle.importKey("raw", s, {
                        name: "AES-CBC"
                    }, !1, [
                        "decrypt"
        ...
        async _hkdfExpandSha256 (n, r, e) {
            ...
            let p = new Uint8Array(0), u = 0, g = 1;
            for(; u < e;){
                const A = new Uint8Array(p.length + t.length + 1);
                A.set(p, 0), A.set(t, p.length), A[A.length - 1] = g & 255, p = new Uint8Array(await crypto.subtle.sign("HMAC", o, A));
                const m = Math.min(p.length, e - u);
                i.set(p.slice(0, m), u), u += m, g++;
            }
            return i;
        },
        parseJson (n) {
...
`;
        ...
        async parse (n, r) {
            ...
            try {
                ...
                const i = atob(e.content), p = new Uint8Array(i.length);
                for(let s = 0; s < i.length; s++)p[s] = i.charCodeAt(s);
                const u = p.slice(0, 12), g = p.slice(12), m = (await de.hash({
                    pass: r,
                    salt: o,
                    time: 2,
                    mem: 19 * 1024,
                    ...
                    additionalData: y,
                    tagLength: 128
                }, w, g), E = new TextDecoder().decode(x), f = JSON.parse(E);
                return this.parsePlaintext(f);
            } catch (t) {
                throw pe.error("Proton Authenticator decryption failed:", t), new Error("INVALID_FORMAT_OR_PASSWORD");
            }
        },
        parsePlaintext (n) {
            ...
            try {
                ...
                for(const A in g){
                    ...
                    for (const y of w){
                        ...
                        if (E.totpUri) {
                            const s = V(E.totpUri);
                            s && (f.name && (s.service = f.name), E.itemUsername && (s.account = E.itemUsername), u.push(s));
                        }
                    }
                }
                return u;
            } catch (e) {
                throw pe.error("Proton Pass PGP decryption failed:", e), new Error("INVALID_FORMAT_OR_PASSWORD");
            }
        }
    }, Ze = {
        isEnteEncrypted (n) {
        ...
        async decryptAndParse (n, r) {
            ...
            if (!r) throw new Error("PASSWORD_REQUIRED");
            const t = ie(e.kdfParams.salt), o = ie(e.encryptionNonce), i = ie(e.encryptedData), { opsLimit: p, memLimit: u } = e.kdfParams, g = Math.floor(u / 1024);
            let A;
            try {
                A = await Ce({
                    password: r,
            ...
            let m;
            try {
                const E = await et(), f = E.crypto_secretstream_xchacha20poly1305_init_pull(o, A), s = E.crypto_secretstream_xchacha20poly1305_pull(f, i);
...
`), x = [];
    ...
    tt = {
        async parse (n) {
            ...
            const t = ((i)=>{
                const p = atob(i.trim()), u = new Uint8Array(p.length);
                for(let y = 0; y < p.length; y++)u[y] = p.charCodeAt(y);
                const g = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
                let A = 0, m = 0, w = "";
                for(let y = 0; y < u.length; y++)for(m = m << 8 | u[y], A += 8; A >= 5;)A -= 5, w += g[m >>> A & 31];
    ...
    rt = {
        async parse (n) {
            try {
                ...
                const o = new TextDecoder().decode(t), i = JSON.parse(o), p = [];
                return (i.accounts || []).forEach((g)=>{
                    (g.vaults || []).forEach((m)=>{
                        (m.items || []).forEach((y)=>{
                            const x = y.overview?.title || "Unknown", E = y.overview?.subtitle || "", f = (s)=>{
                                Array.isArray(s) && s.forEach((a)=>{
                                    a.value && typeof a.value == "object" && a.value.totp && p.push({
                                        service: x,
                                        account: E,
                                        secret: a.value.totp,
                                        algorithm: "SHA1",
                            ...
                            f(y.details?.loginFields), Array.isArray(y.details?.sections) && y.details.sections.forEach((s)=>f(s.fields));
                        });
                    });
                }), p;
            } catch (r) {
    ...
    _t = {
        ...
        async exportData (n, r, e) {
            ...
            switch(t && Array.isArray(n) && (n = n.filter((o)=>t.includes((o.type || "totp").toLowerCase()))), r){
                case "nodeauth_json":
                    return ge.exportPlaintext(n);
                case "nodeauth_encrypted":
                    return await ge.exportEncrypted(n, e);
                case "2fas":
                ...
                case "bitwarden_auth_csv":
                    return me.exportToCsv(n);
                case "bitwarden_auth_json":
                    return me.exportToJson(n);
                case "nodeauth_csv":
        ...
        async parseImportData (n, r, e) {
            ...
            const i = (p)=>typeof p == "string" ? JSON.parse(p) : p;
            switch(r){
                case "nodeauth_json":
                    t = ye.parsePlaintext(o);
                    break;
                case "nodeauth_encrypted":
                    t = await ye.parseEncrypted(o, e);
                    break;
                case "2fas":
                    t = oe.parsePlain(i(o));
                    break;
                case "2fas_encrypted":
                    const p = await oe.decrypt(e, i(o));
                    t = oe.parsePlain({
                        services: p
                    });
                    break;
                ...
                case "bitwarden_pass_encrypted":
                    const u = await ae.decrypt(e, i(o));
                    t = ae.parseJson(u);
                    break;
                case "aegis":
                    t = se.parseEntries(i(o).db || i(o));
                    break;
                case "aegis_encrypted":
                    const g = await se.decryptDatabase(i(o), e);
                    t = se.parseEntries(g);
                    break;
                case "proton_auth":
                    t = we.parsePlaintext(o);
                    break;
                case "proton_auth_encrypted":
                    t = await we.parse(o, e);
                    break;
            ...
            return t.map((p)=>{
                typeof p.account == "string" && p.account.includes(":") && (p.account = p.account.split(":").pop()?.trim() || p.account), (!p.account || p.account.trim() === "") && (p.account = p.service || "Unknown Account");
                const u = le(p);
                return u.id = p.id, u;
            }).filter((p)=>p && p.secret && p.service);
        },
        async exportAsGoogleAuthMigration (n) {
            return await We.exportToGoogleAuth(n);
        },
