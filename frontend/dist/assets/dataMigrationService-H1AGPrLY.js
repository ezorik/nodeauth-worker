...
import { p as K, l as he, v as ce, b as re, __tla as __tla_1 } from "./vaultService-B9_L09VX.js";
import { l as D, d as ge, e as ye, __tla as __tla_2 } from "./index-D2jVkTrJ.js";
import { a as le } from "./argon2-browser-qelKfid9.js";
import { argon2id as me } from "./hash-wasm-Dup_VHWH.js";
import { unzipSync as we } from "./compression-utils-CXh1ITwj.js";
import { a as Ae } from "./qr-utils-DSii33i3.js";
...
`;
        ...
        async exportAsGaMigration (s) {
            ...
            const e = Math.floor(Math.random() * 2147483647), u = await ae(()=>import("./qr-utils-DSii33i3.js").then((h)=>h.b), __vite__mapDeps([0,1,2,3])), n = [];
            function a(h, m) {
        ...
        async exportAsHtml (s) {
            const i = await ae(()=>import("./qr-utils-DSii33i3.js").then((e)=>e.b), __vite__mapDeps([0,1,2,3])), t = [];
            t.push(`
      <!DOCTYPE html>
      <html>
      <head>
